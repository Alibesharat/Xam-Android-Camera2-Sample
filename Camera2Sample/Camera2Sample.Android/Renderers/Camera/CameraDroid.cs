...
namespace Camera2Sample.Droid.Renderers.Camera
{
    public class CameraDroid : FrameLayout, TextureView.ISurfaceTextureListener
    {
        ...
        public void OpenCamera(CameraOptions options,bool TorchMode)
        {
        ...
        public void SwtichFlash(bool TorchMode)
        {
            try
            {
                //Flash mode only open on Rear Camera -- id=0
                _manager.SetTorchMode("0", TorchMode);
